...
module "aws_service_logs" {
  ...
  # optional variables
  cloudtrail_bucket_name    = "mcd-cloudtrail-bucket"
  vpc_flow_logs_bucket_name = "mcd-vpc-flow-logs-bucket"
}
```
...
-- vpc flow logs
select * from mcd_vpc_flow_logs_glue_table where account_id = '111111111111' and region in ('us-east-1', 'eu-west-1') and "timestamp" > '2023/07/01' limit 10;
select * from mcd_vpc_flow_logs_glue_table where account_id = '111111111111' and region in ('us-east-1', 'eu-west-1') and "timestamp" > '2023/07/01/10' and "timestamp" < '2023/07/01/20' limit 10;
```
