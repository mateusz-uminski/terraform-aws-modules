...
variable "project" {
  type        = string
  description = "The name of the project to which the EKS cluster belongs."
}
...
variable "cluster_tier" {
  type        = string
  description = "The tier or category of the vpc in which the EKS cluster will be created."
}
