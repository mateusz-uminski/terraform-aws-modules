...
resource "aws_placement_group" "main" {
  name     = "${local.org}-${var.project}-${var.asg_name}-placement-grp-${var.environment}"
...
resource "aws_launch_template" "main" {
  name        = "${local.org}-${var.project}-${var.asg_name}-lnch-tpl-${var.environment}"
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${local.org}-${var.project}-${var.asg_name}-asg-${var.environment}"
    }
  }
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${local.org}-${var.project}-${var.asg_name}-ebs-${var.environment}"
    }
  }
}
